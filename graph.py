...
Date        : 2026-05-28
Description : Implements a weighted, undirected Graph using an adjacency list.
              Internal storage uses numpy static arrays (no Python lists, no
              built-in graph libraries).  Supports dynamic node/edge insertion,
              BFS, DFS cycle detection, and Dijkstra shortest-path.
